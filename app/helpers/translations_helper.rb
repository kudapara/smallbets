module TranslationsHelper
  TRANSLATIONS = {
    ...
    mentions_webhook_url: { "🇺🇸": "Webhook URL for mentions", "🇪🇸": "URL del Webhook para menciones", "🇫🇷": "URL du webhook pour les mentions", "🇮🇳": "मेंशन के लिए वेबहुक URL", "🇩🇪": "Webhook-URL für Erwähnungen" },
    everything_webhook_url: { "🇺🇸": "Webhook URL for all messages", "🇪🇸": "URL del Webhook para todos los mensajes", "🇫🇷": "URL du webhook pour tous les messages", "🇮🇳": "सभी संदेशों के लिए वेबहुक URL", "🇩🇪": "Webhook-URL für alle Nachrichten" },
